      ...
      <Html>
        <Head>
          ...
          <script
            ...
            data-modal-disclaimer="This is an AI assistant with access to Dwolla developer documentation. Please note that answers are generated by AI so remember to use your own judgement and treat answers with the same healthy skepticism you might treat any other answer on the internet."
            data-modal-example-questions="What is the difference between Dwolla Balance and Dwolla Connect?,How do I ensure real-time updates on payment status with webhooks?"
          ></script>
