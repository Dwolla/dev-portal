...
- The [create an exchange session API endpoint](https://developers.dwolla.com/docs/balance/api-reference/open-banking/create-exchange-session-for-a-customer) now requires a redirect url parameter, which is a single URL that is already configured with Dwolla.
...
- Refer to the [developer documentation](https://developers.dwolla.com/docs/balance/open-banking/visa) for detailed usage instructions and [API reference](https://developers.dwolla.com/docs/balance/api-reference/open-banking/create-exchange-session-for-a-customer).
