...
- Dwolla has discontinued support for the Sift Integration.
- Sift integration toggle in the [Dwolla Dashboard](https://dashboard.dwolla.com/account/integrations) has been removed.
- Monitor our documentation for updates on new fraud prevention features.
