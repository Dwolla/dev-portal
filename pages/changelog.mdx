...
- Added support for creating [access-tokens](https://docs.dwolla.com/#application-authorization) and [client-tokens](https://docs.dwolla.com/#create-a-client-token) in the dwolla-swagger-php SDK. Check it out on [Github](https://github.com/Dwolla/dwolla-swagger-php/releases/tag/1.6.0).
