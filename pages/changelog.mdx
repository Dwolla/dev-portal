...
- Added a new document failure reason, `ForeignPassportNotAllowed`, for when a foreign passport is uploaded for Personal Verified Customers. Foreign passports are still accepted when uploaded for Business Controllers or UBOs.
