...
- **Client:** _Dwolla’s clients, businesses utilizing the Dwolla Payments Platform._
...
- **Partner Integration:** _An integration created in the [Partner Portal](https://partners.dwolla.com). Each integration receives a key & secret to use when integrating_
...
- [Create and retrieve webhook subscriptions for your integration](https://developers.dwolla.com/api-reference/webhook-subscriptions)
- [Retrieve Client account transfers and details](https://developers.dwolla.com/api-reference/accounts/list-and-search-transfers)
- [Read Client account details](https://developers.dwolla.com/api-reference/accounts/retrieve)
- [Retrieve Client funding sources and details](https://developers.dwolla.com/api-reference/accounts/list-funding-sources)
- [Read customer account information](https://developers.dwolla.com/api-reference/customers/retrieve)
- [Retrieve customer funding sources and details](https://developers.dwolla.com/api-reference/funding-sources/list-funding-sources-for-a-customer)
- [Retrieve customer transfers and details](https://developers.dwolla.com/api-reference/transfers/list-and-search-transfers-for-a-customer)
- [Retrieve customer verification documents and details](https://developers.dwolla.com/api-reference/documents/list-documents-for-customer)
...
You can leverage the `access_token` access token granted in Step 5 or Step 6 to [create a webhook subscription](https://developers.dwolla.com/api-reference/#create-a-webhook-subscription).
