...
<img
  src="/assets/images/content-images/funds-flow-send.gif"
  width="75%"
  height="75%"
/>
...
We encourage you to create a sandbox account, if you haven’t already. This will allow you to follow along with the steps outlined in this guide. [Check out our Sandbox setup guide to learn more](/guides/sandbox-setup/).
...
<PaginationWrapper className="center">
  <Paginaton variant="next" variantText="NEXT" href="/add-funding-source">
