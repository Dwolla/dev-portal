...
If your use case involves sending many payments in a single batch, it’s recommended that you leverage our [Mass Payment API](https://developers.dwolla.com/api-reference/#mass-payments) which allows you to send up to 5000 payments with a single API request.
