...
Use the [list an account’s funding sources endpoint](https://developers.dwolla.com/api-reference/#list-funding-sources-for-an-account) to fetch a list of your own funding sources. You’ll need your account URL which can be retrieved by calling [the Root](https://developers.dwolla.com/api-reference/#root) of the API.
...
Use the [list an Customer’s funding sources](https://developers.dwolla.com/api-reference/#list-funding-sources-for-a-customer) endpoint to fetch a list of your own funding sources. You’ll need the Customer URL which can be [retrieved from the API.](https://developers.dwolla.com/api-reference/#list-and-search-customers)
