...
guide:
  step: 1
meta:
  title: Creating A Verified Customer | Dwolla API Documentation
...
There are two types of verified Customers you can create; [Personal Verified Customers](https://developers.dwolla.com/guides/customers/verified-personal) and [Business Verified Customers.](https://developers.dwolla.com/guides/customers/verified-business) In this example, we use [business verified customers](https://developers.dwolla.com/resources/business-verified-customer.html) (sole proprietorship) to represent the merchant who will be receiving funds.
...
**Important:** There are various reasons a Verified Customer will result in a status other than `verified` which you will want to account for after the Customer is created. Reference the Customer verification resource article for more information on [handling verification statuses](https://developers.dwolla.com/guides/customers/verified-business/handle-verification-statuses).

<nav class="pager-nav">
  <a href="obtain-access-token.html">Back: Obtain an access token</a>
  <a href="add-unverified-funding-source.html">
    Next: Attach an unverified funding source
  </a>
</nav>
