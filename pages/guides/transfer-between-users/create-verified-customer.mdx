...
**Important:** There are various reasons a Verified Customer will result in a status other than `verified` which you will want to account for after the Customer is created. Reference the Customer verification resource article for more information on [handling verification statuses](/guides/business-verified-customer/handle-verification-statuses).

<Paginaton variant="previous" variantText="PREVIOUS" href="./"></Paginaton>
<Paginaton
  variant="next"
  variantText="NEXT"
  href="/create-unverified-funding-source"
></Paginaton>
