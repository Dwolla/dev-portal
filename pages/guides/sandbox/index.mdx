...
<AlertBar variation="info">
  When uploading a test image, make sure to keep the size, format, and name of
  the image the same.
</AlertBar>
...
<AlertBar variation="info">
  ...
  , notifications will be sent, including all transfer or micro-deposit related
  events, letting your application know that transfers have processed or failed.
</AlertBar>
