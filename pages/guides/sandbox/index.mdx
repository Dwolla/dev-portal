...
<AlertBar variation="info">
  The times listed above only apply to the Sandbox testing environment. In Production, external ACH transfers are processed at 11 a.m., 1:15 p.m. and 5:45 p.m. (Central Time). This does not apply to any faster payment transactions. All times are subject to change.
</AlertBar>
