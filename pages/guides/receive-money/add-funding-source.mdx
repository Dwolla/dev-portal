...
Once the Customer reaches the page in your application to add a bank account, you’ll send an API request to Dwolla’s server to [generate an IAV token](https://developers.dwolla.com/api-reference/#create-an-iav-token-for-dwolla-js).
