...
<ol class="alerts">
  <li class="alert icon-alert-alert">
    ...
    These can range from a <code>facilitator-fee</code> to collect a portion of
    the transfer amount that is sent to your Dwolla account, or
    <code>correlationId</code> to help correlate transfers from end-to-end. For more
    information on all available transfer request parameters, check out our
...
For more information on which webhooks will be fired for a given section of a transfer, refer to our [Developer Resource Article](https://developers.dwolla.com/articles/webhooks/event-topics).
...
<nav class="pager-nav">
  <a href="retrieve-funding-source.html">Back: Retrieve Funding Sources</a>
</nav>
