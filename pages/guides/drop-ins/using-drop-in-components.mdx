...
| token       | function | A generated single-use client-token.                                                             |
...
<script>
    dwolla.configure({
        ...
        token: () => Promise.resolve("MY_TOKEN"),
...
<div class="customer">
  <dwolla-customer-update
    ...
    firstName="Jack"
    lastName="Jackson"
    email="jjackson@dwolla.com"
    terms="https://www.yourcompany.com/tos"
