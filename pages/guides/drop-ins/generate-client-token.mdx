...
<ExternalCTA
  ...
  href="https://docs.dwolla.com/#create-a-client-token"
  description="For a full list of actions available, view the Drop-in components section in the API Reference docs."
/>
