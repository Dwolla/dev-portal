...
For flow components like Business Verified Customers, Personal Verified Customers, and Payins, it is recommended to use token URL. We also recommend using the token URL if you plan to use multiple drop-in components.
