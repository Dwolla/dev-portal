...
client_token = app_token.post "client-token", request_body
...
appToken.post(`/client-token`).then((res) => res.body.token); // => '4adF858jPeQ9RnojMHdqSD2KwsvmhO7Ti7cI5woOiBGCpH5krY'
```
