...
import iavSavingsAccount from "../../../assets/images/content-images/iav-savings-account.png";

# Step 2: Adding a Funding Source

Within Dwolla, the sending party must always [verify their bank account](/guides/dwolla-js/instant-account-verification) in order to be eligible to create a transfer.
...
<Image
  src={iavSavingsAccount}
  alt="IAV savings account type select"
  width="75%"
  height="75%"
/>
<Paginaton
