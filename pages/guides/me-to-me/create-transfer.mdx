...
While pending bank transfers can be processed at any time in the Sandbox, behavior will vary in production depending on if your application has access to expedited transfers versus standard ACH transfer times. Refer to our [developer resource article](https://developers.dwolla.com/articles/transfers/processing-times) to learn more on transfer timing in production.
...
<nav class="pager-nav">
  <a href="retrieve-funding-source.html">Back: Fetch Funding Source</a>
</nav>
