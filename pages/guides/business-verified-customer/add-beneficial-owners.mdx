...
If an individual beneficial owner needs to update their information after being verified, there are two ways of accomplishing it:

- remove the individual beneficial owner and re-add with updated information
- contact Dwolla to place the beneficial owner into incomplete status again so that the owner's information can be updated
