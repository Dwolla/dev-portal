...
If an individual benficial owner with a status of `verified` needs to update their information, that beneficial owner will first need to be removed and re-added.
