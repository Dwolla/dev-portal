...
<AlertBar variation="info">
  ...
  `incomplete` status; simply passing the same information will result in the
  same insufficient scores. All fields that were required in the initial
  beneficial owner creation attempt will be required in the `incomplete`
  attempt.
</AlertBar>
...
<Paginaton
  ...
  href="/handle-verification-statuses"
></Paginaton>
<Paginaton
  variant="next"
  variantText="NEXT"
  href="/certify-beneficial-owners"
></Paginaton>
