...
guide:
  step: 7
meta:
  title: "Initiate Micro Deposits for bank verification | Dwolla API Documentation"
---

# Initiate micro-deposits

This section covers how to initiate micro-deposits for bank verification. Reference the [funding source verification](https://developers.dwolla.com/concepts/bank-funding-source#bank-addition--verification-methods) resource article for more information on the micro-deposit method of bank account verification.
