...
- `_links.redirect-url` (conditional): A **required** redirect URL for Visa exchange sessions. This URL will be used to redirect the user back to your application after completing the authorization process. For Plaid and MX exchange sessions, this parameter is **not required**.
