...
exchange_session = app_token.get exchange_session_url
exchange_session['externalProviderSessionToken'] # => "link-production-b41e8ed3-0874-4c64-b07d-a77088979d5f"
```
...
exchange_session = app_token.get(exchange_session_url)
exchange_session.body['externalProviderSessionToken'] # => 'link-production-b41e8ed3-0874-4c64-b07d-a77088979d5f'
```
...
dwolla
  .get(exchangeSessionUrl)
  .then((res) => res.body.externalProviderSessionToken); // => "link-production-b41e8ed3-0874-4c64-b07d-a77088979d5f"
```
...
exchange_session = app_token.get exchange_session_url
exchange_session['_links']['external-provider-session']['href'] # => "https://int-widgets.moneydesktop.%3D"
```
