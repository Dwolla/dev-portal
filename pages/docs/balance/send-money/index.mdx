...
guide:
  ...
  icon: send-funds.svg
meta:
  title: Money Transfer API | Digital Disbursements | Dwolla
  description: Utilize Dwolla's money transfer API for digital disbursements. Send money to users' bank accounts. Get started today!
---
