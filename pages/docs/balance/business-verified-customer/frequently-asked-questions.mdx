...
>
  <p>
    ...
    <ul>
      <li>
        <a
          href="/docs/balance/business-verified-customer/add-beneficial-owners"
          target="_blank"
        >
      ...
      <li>
        <a
          href="/docs/balance/business-verified-customer/certify-beneficial-ownership"
          target="_blank"
        >
...
>
  <p>
    ...
    <a href="/api-reference/funding-sources/list-funding-sources-for-a-customer">
      {" "}
      via the API{" "}
    </a>{" "}
