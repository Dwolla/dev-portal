...
| businessClassification | yes      | string | The industry classification Id that corresponds to Customer’s business. [Reference our Dev Docs](/api-reference/customers/list-business-classifications) to learn how to generate this Id.                  |
