...
| ForeignPassportNumberRequired    | A foreign passport has been provided for verification. Please provide the passport number to complete the verification, or upload a U.S. government-issued ID if available.                                                                              | Update Controller Info OR Upload New Document      |
