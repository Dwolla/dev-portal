...
| [Drop-in components](https://developers.dwolla.com/docs/drop-in-components)                                  | No                                                      | Bank Account Number, <br /> Routing number | 100%              | Checking, <br /> Savings                                     | Tokenized data, <br /> Optional bank verification with [Microdeposits](https://developers.dwolla.com/docs/drop-in-components#verify-micro-deposits)        |
