...
If you have an active [webhook subscription](https://developers.dwolla.com/guides/webhooks/create-subscription/subscribe-to-webhooks), you will receive the `customer_created` webhook immediately after the resource has been created.
