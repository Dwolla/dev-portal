...
| Return Code | Description                                              | Customer Deactivated or Suspended | Bank Removed |
| ----------- | -------------------------------------------------------- | --------------------------------- | ------------ |
| R01         | Insufficient Funds                                       | No                                | No           |
| R02         | Bank Account Closed                                      | No                                | Yes          |
| R03         | No Account/Unable to Locate Account                      | No                                | Yes          |
| R04         | Invalid Bank Account Number Structure                    | No                                | Yes          |
| R05         | Unauthorized debit to consumer account                   | Yes                               | Yes          |
