---
title: Creating the Business Verified Customer
---
...
- **Quick-link** - [Create a business verified Customer with no Controller](https://developers.dwolla.com/guides/customers/verified-business/create-a-customer.html#request-parameters-create-a-business-verified-customer-with-no-controller)
- **Quick link** - [Create a business verified Customer and Controller](https://developers.dwolla.com/guides/customers/verified-business/create-a-customer.html#request-parameters-create-a-business-verified-customer-and-controller)
