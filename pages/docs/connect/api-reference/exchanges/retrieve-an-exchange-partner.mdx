...
guide:
  step: 2
meta:
  title: "Dwolla API Reference | Exchanges: Retrieve an Exchange Partner"
  description: "Secure Exchange Solution: Retrieve a Dwolla Connect exchange partner by its ID."
---
