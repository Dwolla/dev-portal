...
guide:
  step: 1
meta:
  title: "Dwolla API Reference | Accounts: Retrieve an Account"
  description: "Endpoint for retrieving basic account information belonging to the main Dwolla Connect account."
---
...
account_url = 'https://api.dwolla.com/accounts/3b0f270c-9cfd-4724-bae8-aa4b1659cbb4'
...
$accountUrl = 'https://api.dwolla.com/accounts/3b0f270c-9cfd-4724-bae8-aa4b1659cbb4';
...
var accountUrl =
  "https://api.dwolla.com/accounts/3b0f270c-9cfd-4724-bae8-aa4b1659cbb4";
