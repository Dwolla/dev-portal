...
guide:
  step: 0
meta:
  title: "Dwolla API Reference | External Parties: Overview"
...
import PersonalExternalParty from "../../../../../assets/api-resource-tables/external-parties/PersonalExternalParty";
