...
weight: 1
meta:
  title: Planning Your Integration | Dwolla Documentation
  description: Streamline your Dwolla Connect integration journey with our comprehensive Integration Checklist and expert resources.
---
...
This Integration Checklist includes a high level overview of the steps you need to take to ensure a smooth implementation. It covers everything from getting started and building your integration to going live in production.

| Components                                                                                                            | Tasks                                                                                                                | Notes |
| --------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ----- |
| Design                                                                                                                | Evaluate use cases and align on funds flows to determine if there will be debits (pay-ins) credits (payouts) or both |       |
| Confirm banking partner and eligible account                                                                          |                                                                                                                      |
| Bank Setup                                                                                                            | Have client reach out to their banking partner                                                                       |       |
| Dwolla to send notice to banking relationship partner                                                                 |                                                                                                                      |
| Review and agree to bank pricing                                                                                      |                                                                                                                      |
| Share KYC / KYB documentation with bank                                                                               |                                                                                                                      |
| Set up accounts with banking partner                                                                                  |                                                                                                                      |
| Sign ACH agreement with banking partner                                                                               |                                                                                                                      |
| Sign third party service agreement with banking partner allowing Dwolla to submit payment instructions on your behalf |                                                                                                                      |
| Contract                                                                                                              | Review and sign Connect services agreement                                                                           |       |
| Account Setup                                                                                                         | Sign-up for account and agree to developer terms of service                                                          |       |
| Complete Information Security questionnaire                                                                           | Dwolla will provide a link                                                                                           |
| Collect account setup information and treasury account information                                                    | Dwolla will provide a link                                                                                           |
| Complete compliance and risk assessment of business                                                                   |                                                                                                                      |
| Testing                                                                                                               | Client to test in Sandbox External Parties, Funding Sources, and Transfer creation                                   |       |
| Production                                                                                                            | Activate production account upon completion of Sandbox Integration                                                   |       |
