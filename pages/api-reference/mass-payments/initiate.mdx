...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \_links           | A \_links JSON object describing the desired `destination` of a mass payment. [See above](https://developers.dwolla.com/api-reference/mass-payments/initiate#source-and-destination-values) for possible values for `destination`.                                                                                                                                                                        |
...
| clearing          | A clearing JSON object that contains `destination` key to expedite a transfer. [Reference the clearing JSON object to learn more](https://developers.dwolla.com/api-reference/mass-payments/initiate#clearing-json-object-mass-payment).                                                                                                                                                                  |
