...
| --------------- | -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \_links         | no       | object | A <code>\_links</code> JSON object containing an [`on-demand-authorization`](/api-reference/transfers#create-an-on-demand-transfer-authorization) link relation. See example raw request and response below.                                                                                                                                                                                                                                                                                                                                                                                                                |
...
### Request and response - using [on-demand authorization](/api-reference/transfers#create-an-on-demand-transfer-authorization)
