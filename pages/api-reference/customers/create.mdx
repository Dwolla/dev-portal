...
| correlationId | no       | string | A unique string value attached to a customer which can be used for traceability between Dwolla and your application. **Note:** A correlationId is not a replacement for an [idempotency-key](https://developers.dwolla.com/api-reference#idempotency-key). <br /> Must be less than or equal to 255 characters and contain no spaces. <br /> Acceptable characters are: `a-Z`, `0-9`, `-`, `.`, and `_`. <br /> **Note:** Sensitive Personal Identifying Information (PII) should not be used in this field and it is recommended to use a random value for correlationId, like a UUID. Uniqueness is enforced on correlationId across Customers. |
...
| businessName  | no       | string | Customer's registered business name. (**Optional** if not a business entity, though if a business name is supplied, it must be 255 characters or fewer, and cannot include any special characters.)                                                                                                                                                                                                                                                                                                         |
| ipAddress     | no       | string | Customer's IP address.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| correlationId | no       | string | A unique string value attached to a customer which can be used for traceability between Dwolla and your application. <br /> Must be less than or equal to 255 characters and contain no spaces. <br /> Acceptable characters are: `a-Z`, `0-9`, `-`, `.`, and `_`. <br /> **Note:** Sensitive Personal Identifying Information (PII) should not be used in this field and it is recommended to use a random value for correlationId, like a UUID. Uniqueness is enforced on correlationId across Customers. |
...
| businessClassification | yes      | string | The industry classification Id that corresponds to Customer’s business. Reference the [Business Classifications section](https://developers.dwolla.com/api-reference/customers/list-business-classifications) to learn how to generate this Id.                                                                                                                                                                                                                                                             |
...
| ssn         | conditional | String | Last four or full 9 digits of controller’s Social Security Number. **Required** for US persons. If SSN is omitted, [passport](https://developers.dwolla.com/api-reference/customers/create#controller-passport-json-object) is required.                                                  |
| address     | yes         | object | An [address JSON object](https://developers.dwolla.com/api-reference/customers/create#controller-address-json-object). Full address of the controller's physical address.                                                                                                                 |
| passport    | conditional | object | An [optional passport JSON object](https://developers.dwolla.com/api-reference/customers/create#controller-passport-json-object). **Required** for non-US persons. Includes Passport Identification Number and Country. If [passport](#passport-json-object) is omitted, SSN is required. |
