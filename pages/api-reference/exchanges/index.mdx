...
As more functionality is released, the functions this end point can perform will continue to expand.
...
| status    | Status of the exchange. One of: active, deactivated, or removed.          |
