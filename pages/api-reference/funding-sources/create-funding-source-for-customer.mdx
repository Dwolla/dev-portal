...
<AlertBar variation="warning">
  ...
  <a href="/concepts/customer-types#verified-customer">Verified Customers</a> and
...
| --------------- | -------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| \_links         | no       | object | A <code>\_links</code> JSON object containing an [`on-demand-authorization`](https://developers.dwolla.com/api-reference/transfers/create-an-on-demand-transfer-authorization) link relation. See example bash request and response below.                                                                                                                                                                                                                                                                                                                                                                                  |
