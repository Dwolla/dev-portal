...
For an example of using on-demand authorization, see the example for adding a customer funding source using Plaid Link [here](https://github.com/Dwolla/integration-examples/tree/main/packages/plaid-funding-source).
