...
meta:
  ...
  description: "Create, update, remove, or retrieve, a funding source with the API. Use Intsant Acctount Verification (IAV) or micro depositis to verify the funding source."
---
