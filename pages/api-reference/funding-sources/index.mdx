...
meta:
  ...
  description: "Create, update, remove or retrieve a funding source with the API. Use Finicity or MX via Secure Exchange, Plaid, or micro deposits to verify the funding source."
---
