...
```bash
GET https://api-sandbox.dwolla.com/transfers/49dbaa24-1580-4b1c-8b58-24e26656fa31
...

{
    "_links": {
        "self": {
            "href": "https://api-sandbox.dwolla.com/transfers/e33e8078-94cf-4bcc-b648-b6f416bbcee5",
