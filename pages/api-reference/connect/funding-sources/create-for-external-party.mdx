...
```bash
POST https://api-sandbox.dwolla.com/external-parties/99bfb139-eadd-4cdf-b346-7504f0c16c60/funding-sources
...
```ruby
# Using dwolla_v2 - https://github.com/Dwolla/dwolla-v2-ruby
external_parties_url = 'https://api-sandbox.dwolla.com/external-parties/AB443D36-3757-44C1-A1B4-29727FB3111C'
request_body = {
  _links: {
    'exchange': {
      href: "https://api-sandbox.dwolla.com/exchanges/6bc9109a-04fd-49b6-ace6-ca06fd282d65"
