...
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| funding_source:created                | **Description:** A funding source was added to a main Dwolla Account.<br /> **Timing:** Occurs upon a POST request to the [Create a funding source for an account](https://developers.dwolla.com/api-reference/connect/funding-sources/https://developers.dwolla.com/api-reference/connect/funding-sources/create-for-account) endpoint, or when a funding source is added via a third party bank verification method. |
| funding_source:removed                | **Description:** A funding source was removed from a main Dwolla Account.<br /> **Timing:** Occurs upon a POST request to the [Remove a funding source](https://developers.dwolla.com/api-reference/connect/funding-sources/remove) endpoint.                                                                                                                                                                          |
| external_party.funding_source:created | **Description:** A funding source was added to an External Party.<br /> **Timing:** Occurs upon a POST request to the [Create a funding source for an external party](https://developers.dwolla.com/api-reference/connect/funding-sources/create-for-external-party) endpoint, or when a funding source is added via a third party bank verification method.                                                           |
| external_party.funding_source:removed | **Description:** A funding source was removed from a main Dwolla Account.<br /> **Timing:** Occurs upon a POST request to the [Remove a funding source](https://developers.dwolla.com/api-reference/connect/funding-sources/remove) endpoint.                                                                                                                                                                          |
...
| transfer:processed | **Description:** **Description:** An account-to-account transfer was updated from pending to processed. A processed status represents completed processing with the Financial Institution. <br /> **Timing:** Occurs when the transfer is expected to be successful based on the designated processing time.                                                                                                                                                                              |
| transfer:failed    | **Description:** An account-to-account transfer was updated from pending to failed. <br /> **Timing:** Occurs after a transfer.pending event when a transaction fails to be submitted for processing. Additional details are available in an embedded `failureReason` object when retrieving a transfer.                                                                                                                                                                                  |
