...
guide:
  step: 2
meta:
  title: "Dwolla API Reference | External Parties: Retrieve External Party"
...
external_party_url = 'https://api.dwolla.com/external-parties/fc451a7a-ae30-4404-aB95-e3553fcd733'

customer = app_token.get external_party_url
...
var externalPartyUrl =
  "https://api.dwolla.com/external-parties/fc451a7a-ae30-4404-aB95-e3553fcd733";

dwolla.get(externalPartyUrl).then((res) => res.body.firstName); // => 'Jane'
```
