...
What makes the Dwolla balance useful in relation to the platform is that the funds are held within the Dwolla network. This means the Dwolla balance acts as a funding source associated directly with each Verified Customer within your application. This funding source can only be accessed from your application by the end user, and you must provide an easily accessible and accurate summary of the [total and available balance](/concepts/balance-funding-source#total-and-available-balance) as well as transfer history for the Customer’s Dwolla balance.
