...
**The use case:**
I want to add a U.S. bank account by supplying an account and routing number. The bank will be unverified until microdeposits are [initiated](https://docs.dwolla.com/#initiate-micro-deposits) and [verified](https://docs.dwolla.com/#verify-micro-deposits).
