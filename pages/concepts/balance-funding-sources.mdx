...
For more information on possible transfer failure scenarios and the Return Codes associated with each, check out our [Transfer Failures developer resources article](/concepts/transfer-failures.html).
