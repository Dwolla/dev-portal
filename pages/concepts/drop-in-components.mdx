...
##### CSS Classes for Create Funding Source
...
The latest version of **dwolla-web.js** is `2.1.9`. If you are currently using `v2`, we recommend [upgrading](https://developers.dwolla.com/guides/drop-ins/setup-and-configuration#include-dwolla-webjs) to `2.1.9`.
