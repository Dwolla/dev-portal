...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) action: `customer.create`
...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) action: `customer.update`
...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) possible actions: `beneficialowners.create`, `beneficialownership.read`, `customer.read`, `beneficialownership.certify`, `beneficialowners.update`, `beneficialowner.documents.create`, `beneficialowner.delete`
...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) action: `customer.documents.create` or `beneficialowner.documents.create`
...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) action: `customer.fundingsources.read`
...
[Create client-token](https://developers.dwolla.com/api-reference/#create-a-client-token) action: `customer.transfers.send`
