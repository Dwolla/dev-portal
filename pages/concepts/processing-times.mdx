...
meta:
  ...
  description: Adding a bank to a Customer can be done in a variety of ways, including instant authentication or account and routing number.
---

import AlertBar from "../../components/base/AlertBar";
import Image from "../../components/base/Image";
import achTransferTimeline from "../../assets/images/content-images/ach-transfer-timeline.png";
import achNextDay from "../../assets/images/content-images/ach-next-day.png";
import achSameDay from "../../assets/images/content-images/ach-same-day.png";
...
<Image src={achTransferTimeline} alt="ACH transfer timeline" />
...
<AlertBar variation="warning">
  With `next-day` enabled, ACH processing is expedited, meaning that checks for
  common return codes may not be processed until a later time. This also means
  that the risk of losses incurred from return codes is higher.
</AlertBar>
...
<Image src={achSameDay} alt="ACH transfer timeline Same Day" />
...
In this bank-to-bank transfer request example we have `next-day` enabled, but we want to slow the transfer clearing into the Dwolla network back to `standard`. However, we feel comfortable letting this transfer export out of the Dwolla Network with `same-day` clearing to the destination bank.
