...
meta:
  ...
  description: The Dwolla API enables the use of Same Day ACH credit transfers, a feature for platforms looking to offer expedited transfers and improve end-user experience.
---
