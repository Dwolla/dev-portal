...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| [Customer Created](https://developers.dwolla.com/api-reference/#create-a-customer)                                   | [$create_account](https://sift.com/developers/docs/curl/events-api/reserved-events/content-status)                                   | `user_id`, `name`, `user_email`, `phone` (optional), `address` (Billing Address)
| [Customer Updated](https://developers.dwolla.com/api-reference/#update-a-customer)                                   | [$update_account](https://sift.com/developers/docs/curl/events-api/reserved-events/update-account)                                   | Same as above in addition to: `customField ("type"= accountType (personal or business))`, `customField ( "status" = (suspended))`, `payment_methods = routing_number`
| [Customer Suspended](https://developers.dwolla.com/api-reference/#update-a-customer)                                 | [Label User](https://sift.com/developers/docs/curl/labels-api/label-user) with $abuse_type = 'account_abuse'                         | `api_key`, `abuse_type = account_abuse`
| [Customer Funding Source Added](https://developers.dwolla.com/api-reference/#create-a-funding-source-for-a-customer) | [$update_account](https://sift.com/developers/docs/curl/events-api/reserved-events/update-account)                                   | 
| [Customer Funding Source Removed](https://developers.dwolla.com/api-reference/#remove-a-funding-source)              | [$update_account](https://sift.com/developers/docs/curl/events-api/reserved-events/update-account)                                   |
...
| [Transfers In](https://developers.dwolla.com/api-reference/#initiate-a-transfer)                                     | [$transaction](https://sift.com/developers/docs/curl/events-api/reserved-events/transaction) with $transaction_type = '$deposit'     |
| [Transfers Out](https://developers.dwolla.com/api-reference/#initiate-a-transfer)                                    | [$transaction](https://sift.com/developers/docs/curl/events-api/reserved-events/transaction) with $transaction_type = '$withdrawal'  |
